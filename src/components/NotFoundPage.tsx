...
export default function NotFoundPage() {
  ...
  return (
    <main
      ...
      className="not-found-screen min-h-screen flex items-center justify-center bg-gradient-to-br from-[#F8FAFC] via-blue-50 to-teal-50 px-6 relative overflow-hidden"
    >
      {/* Background Decorative Elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-20 w-72 h-72 bg-[#1E3A8A]/5 rounded-full blur-3xl animate-pulse" />
        <div
          className="absolute bottom-20 right-20 w-96 h-96 bg-[#0EA5A4]/5 rounded-full blur-3xl animate-pulse"
        ...
        >
          ...
          >
            <div className="relative inline-block">
              ...
              >
                <div className="w-32 h-32 md:w-40 md:h-40 border-4 border-[#0EA5A4]/20 rounded-full" />
              </motion.div>
            </div>
          </motion.div>
          ...
          >
            ...
            <p className="text-sm text-gray-500">Don&#39;t worry, even the best explorers get lost sometimes.</p>
          </motion.div>
