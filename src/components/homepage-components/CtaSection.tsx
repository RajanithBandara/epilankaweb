...
function CtaSection() {
    return(
        <section className="px-6 py-20 mx-4 md:mx-8 my-8 mb-20 relative z-10">
            <div className="relative bg-gradient-to-br from-winered via-[#8B0000] to-winered rounded-3xl shadow-[0_20px_70px_rgba(164,17,17,0.3)] border border-winered/30 overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto text-center relative z-10 px-8 py-12">
                    ...
                    {/* Description */}
                    <p className="text-xl md:text-2xl text-white/95 mb-10 max-w-2xl mx-auto leading-relaxed font-medium drop-shadow-lg">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                        <a
                            href="/dashboard"
                            className="group relative inline-flex items-center gap-3 bg-white text-black font-bold px-10 py-5 rounded-xl shadow-[0_20px_40px_rgba(255,255,255,0.2)] hover:shadow-[0_20px_60px_rgba(255,255,255,0.4)] hover:scale-105 transition-all duration-300 text-lg overflow-hidden"
                        >
                            {/* Button shine effect */}
