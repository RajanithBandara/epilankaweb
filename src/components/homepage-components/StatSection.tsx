...
function StatSection() {
    ...
    return (
        <section className="py-6 px-6 mx-4 md:mx-8 -mt-12 relative z-10">
            <div className="max-w-5xl mx-auto">
                {/* Main card with enhanced glassmorphism */}
                <div className="relative bg-black/20 backdrop-blur-xl rounded-3xl shadow-[0_20px_70px_rgba(164,17,17,0.15)] border border-white/10 overflow-hidden">
                        ...
                        {stats.map((stat, index) => (
                            ...
                            >
                                ...
                                <div className="relative mb-1">
                                    <div className="text-3xl md:text-4xl font-black bg-white/80 bg-clip-text text-transparent group-hover:scale-105 transition-all duration-500 inline-block">
                                        {stat.value}
                                    </div>

                                    {/* Animated underline */}
                                    <div className="h-0.5 w-0 group-hover:w-full bg-gradient-to-r from-transparent via-winered to-transparent mx-auto mt-1 transition-all duration-500 rounded-full"></div>
                                </div>
