        ...
        return (
            <div className="flex min-h-[60vh] items-center justify-center">
                <div className="w-full max-w-2xl space-y-4 px-4">
                    <div className="h-8 w-1/3 bg-foreground/10 rounded-md animate-pulse" />
                    <div className="space-y-3">
                        <div className="h-6 w-full bg-foreground/10 rounded-md animate-pulse" />
                        <div className="h-6 w-5/6 bg-foreground/10 rounded-md animate-pulse" />
                        <div className="h-6 w-4/6 bg-foreground/10 rounded-md animate-pulse" />
                    </div>
                </div>
            </div>
        );
